    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/usuarios')) {
            ...
            if (rtrim($pathinfo, '/') === '/usuarios') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'app_usuarios_index');
                }

                return array (  '_controller' => 'AppBundle\\Controller\\UsuariosController::indexAction',  '_route' => 'app_usuarios_index',);
            }

            // app_usuarios_registrar
            if (rtrim($pathinfo, '/') === '/usuarios/registrar') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'app_usuarios_registrar');
                }

                return array (  '_controller' => 'AppBundle\\Controller\\UsuariosController::registrarAction',  '_route' => 'app_usuarios_registrar',);
            }

            if (0 === strpos($pathinfo, '/usuarios/e')) {
                // app_usuarios_editar
                if (0 === strpos($pathinfo, '/usuarios/editar') && preg_match('#^/usuarios/editar/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
                    if (substr($pathinfo, -1) !== '/') {
                        return $this->redirect($pathinfo.'/', 'app_usuarios_editar');
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'app_usuarios_editar')), array (  '_controller' => 'AppBundle\\Controller\\UsuariosController::editarAction',));
                }

                // app_usuarios_eliminar
                if (0 === strpos($pathinfo, '/usuarios/eliminar') && preg_match('#^/usuarios/eliminar/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
                    if (substr($pathinfo, -1) !== '/') {
                        return $this->redirect($pathinfo.'/', 'app_usuarios_eliminar');
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'app_usuarios_eliminar')), array (  '_controller' => 'AppBundle\\Controller\\UsuariosController::eliminarAction',));
                }
